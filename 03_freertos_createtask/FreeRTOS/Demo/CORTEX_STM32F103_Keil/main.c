...
void Task2Funtion(void * parm)
{
	while(1)
	printf("2");
}

void Task3Funtion(void * parm)
{
	while(1)
	printf("3");
}
...
int main( void )
{
  ...
  debug();
	...
	xTaskCreate(Task2Funtion, "Task2", 100, NULL, 1, NULL);
	xTaskCreate(Task3Funtion, "Task3", 100, NULL, 1, NULL);
