...
void OLED_Init(void)
{
	...
	GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//速度50MHz
 	...
 	GPIO_WriteBit(GPIOB,GPIO_Pin_5|GPIO_Pin_4|GPIO_Pin_6|GPIO_Pin_7,Bit_SET);
	...
	OLED_RES_Clr();
	IIC_delay();IIC_delay();IIC_delay();IIC_delay();IIC_delay();IIC_delay();IIC_delay();IIC_delay();IIC_delay();
	OLED_RES_Set();
